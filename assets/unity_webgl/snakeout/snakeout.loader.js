function createUnityInstance(t, n, l) {
  ...
  var o,
    b = {
      canvas: t,
      webglContextAttributes: { preserveDrawingBuffer: !1, powerPreference: 1 },
      wasmFileSize: 13372412,
  ...
  for (o in (e(n, "companyName", "Unity"), e(n, "productName", "WebGL Player"), e(n, "productVersion", "1.0"), n)) b[o] = n[o];
  ...
  function u(e) {
    document.webkitCurrentFullScreenElement === t
      ? t.style.width && ((s = t.style.width), (d = t.style.height), (t.style.width = "100%"), (t.style.height = "100%"))
  ...
  function S(e, t) {
    if ("symbolsUrl" != e) {
      var n = b.downloadProgress[e],
        r =
          ((n = n || (b.downloadProgress[e] = { started: !1, finished: !1, lengthComputable: !1, total: 0, loaded: 0 })),
          "object" != typeof t ||
      ...
      try {
        return window.WebAssembly
          ? WebAssembly.validate(
            ...
            ? WebAssembly.validate(
                new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 11, 1, 9, 1, 1, 125, 32, 0, 252, 0, 26, 11])
              )
              ? WebAssembly.validate(
                  new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 10, 1, 8, 1, 1, 126, 32, 0, 194, 26, 11])
                )
                ? WebAssembly.validate(
                    new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 9, 1, 7, 0, 65, 0, 253, 15, 26, 11])
                  )
                  ? !!WebAssembly.validate(
                      new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 10, 1, 8, 0, 6, 64, 1, 25, 1, 11, 11])
                    ) || "wasm-exceptions"
                  : "wasm-simd128"
                : "sign-extend"
        ...
        (function o() {
          return void 0 === e
            ...
            : e.read().then(function (e) {
                ...
                return (
                  f + e.value.length <= d.length ? (d.set(e.value, f), (h = f + e.value.length)) : u.push(e.value),
                  (f += e.value.length),
                  i({ type: "progress", response: a, total: Math.max(c, f), loaded: f, lengthComputable: l, chunk: s ? e.value : null }),
                  o()
                );
              });
        })().then(function (e) {
      ...
      (E.prototype.cleanUpCache = function () {
        ...
        return this.getMetaDataEntries().then(function (e) {
          for (var t = e.metaDataEntries, n = e.cacheSize, r = [], o = [], a = 0; a < t.length; ++a)
            t[a].version == b.productVersion ? o.push(t[a]) : (r.push(t[a]), (n -= t[a].size));
          o.sort(function (e, t) {
            ...
            return !l.enabled || l.revalidated
              ...
              : 304 === e.status
                ...
                : 200 == e.status
                  ? ((l.response = e),
                    ...
                    k(e, r.onProgress, r.enableStreamingDownload).then(function (e) {
                      return (
                        ...
                        Promise.all([i.storeRequest(n, t), i.updateRequestMetaData(l.metaData)])
                          .then(function () {
                  ...
                  : (C("'" + s + "' request failed with status: " + e.status + " " + e.statusText), k(e, r.onProgress, r.enableStreamingDownload));
          });
        }
        return (
          a && ((l.control = a.control), (l.companyName = a.companyName), (l.productName = a.productName), (l.productVersion = a.productVersion)),
          (l.revalidated = !1),
          (l.metaData = { url: s, accessedAt: Date.now(), version: l.productVersion }),
          (l.response = null),
          l.enabled
            ? i
                .loadRequest(s)
                                ...
                                return (
                                  ...
                                  l.revalidated
                                    ? (i.updateRequestMetaData(r).then(function () {
                                      ...
                                      k(l.response, a.onProgress, a.enableStreamingDownload))
                                    : c(o, a)
                                );
                              })))
                    : c(o, a);
                ...
                .catch(function (e) {
                  return C("Failed to load '" + l.metaData.url + "' from browser cache due to the error: " + e), y(o, a);
                })
            : y(o, a)
        );
      }));
  var A = {
          ...
          n = {
            "inflate.js": function (e, t, n) {
              ...
              (i.prototype.push = function (e, t) {
                ...
                do {
                  if (
                    ...
                    (n = u.inflate(s, m.Z_NO_FLUSH)) === m.Z_NEED_DICT &&
                      c &&
                      ((i = "string" == typeof c ? h.string2buf(c) : "[object ArrayBuffer]" === b.call(c) ? new Uint8Array(c) : c),
                  ...
                  (!s.next_out ||
                    (0 !== s.avail_out && n !== m.Z_STREAM_END && (0 !== s.avail_in || (r !== m.Z_FINISH && r !== m.Z_SYNC_FLUSH))) ||
                ...
                return (r = n === m.Z_STREAM_END ? m.Z_FINISH : r) === m.Z_FINISH
                  ? ((n = u.inflateEnd(this.strm)), this.onEnd(n), (this.ended = !0), n === m.Z_OK)
                  : r !== m.Z_SYNC_FLUSH || (this.onEnd(m.Z_OK), !(s.avail_out = 0));
              }),
                ...
                (i.prototype.onEnd = function (e) {
                  e === m.Z_OK &&
                    ("string" === this.options.to ? (this.result = this.chunks.join("")) : (this.result = f.flattenChunks(this.chunks))),
                    (this.chunks = []),
                    (this.err = e),
            ...
            "zlib/inflate.js": function (e, t, n) {
              ...
              function l(e, t) {
                ...
                return !e ||
                  !e.state ||
                  ((r = e.state), t < 0 ? ((n = 0), (t = -t)) : ((n = 1 + (t >> 4)), t < 48 && (t &= 15)), t && (t < 8 || 15 < t))
                  ? O
                  : (null !== r.window && r.wbits !== t && (r.window = null), (r.wrap = n), (r.wbits = t), s(e));
              }
              function c(e, t) {
                var n;
                return e ? ((n = new a()), ((e.state = n).window = null), (n = l(e, t)) !== L && (e.state = null), n) : O;
              }
              var H,
                M,
                W = !0;
              function Z(e, t, n, r) {
                var o;
                return (
                  null === (e = e.state).window && ((e.wsize = 1 << e.wbits), (e.wnext = 0), (e.whave = 0), (e.window = new D.Buf8(e.wsize))),
                  r >= e.wsize
                    ? (D.arraySet(e.window, t, n - e.wsize, e.wsize, 0), (e.wnext = 0), (e.whave = e.wsize))
                    : (r < (o = e.wsize - e.wnext) && (o = r),
                      D.arraySet(e.window, t, n - r, o, e.wnext),
                      (r -= o)
                        ? (D.arraySet(e.window, t, n - r, r, 0), (e.wnext = r), (e.whave = e.wsize))
              ...
              (n.inflateReset = s),
                ...
                (n.inflate = function (e, t) {
                    ...
                    switch (n.mode) {
                      case F:
                        if (0 === n.wrap) n.mode = 13;
                          ...
                          if (2 & n.wrap && 35615 === c)
                            (U[(n.check = 0)] = 255 & c), (U[1] = (c >>> 8) & 255), (n.check = R(n.check, U, 2, 0)), (d = c = 0), (n.mode = 2);
                          else if (((n.flags = 0), n.head && (n.head.done = !1), !(1 & n.wrap) || (((255 & c) << 8) + (c >> 8)) % 31))
                      ...
                      case 2:
                        ...
                        n.head && (n.head.text = (c >> 8) & 1),
                          512 & n.flags && ((U[0] = 255 & c), (U[1] = (c >>> 8) & 255), (n.check = R(n.check, U, 2, 0))),
                          (d = c = 0),
                          (n.mode = 3);
                      case 3:
                        for (; d < 32; ) {
                      ...
                      case 7:
                        if (2048 & n.flags) {
                          ...
                          if ((512 & n.flags && (n.check = R(n.check, r, h, a)), (s -= h), (a += h), _)) break e;
                      ...
                      case 11:
                        if (0 === n.havedict)
                          return (e.next_out = i), (e.avail_out = l), (e.next_in = a), (e.avail_in = s), (n.hold = c), (n.bits = d), 2;
                          ...
                          switch (((n.last = 1 & c), --d, 3 & (c >>>= 1))) {
                            ...
                            case 1:
                              var T,
                                ...
                                P = n;
                              if (W) {
                                for (H = new D.Buf32(512), M = new D.Buf32(32), T = 0; T < 144; ) P.lens[T++] = 8;
                                for (; T < 256; ) P.lens[T++] = 9;
                                for (; T < 280; ) P.lens[T++] = 7;
                                for (; T < 288; ) P.lens[T++] = 8;
                                for (z(1, P.lens, 0, 288, H, 0, P.work, { bits: 9 }), T = 0; T < 32; ) P.lens[T++] = 5;
                                z(2, P.lens, 0, 32, M, 0, P.work, { bits: 5 }), (W = !1);
                              }
                              if (((P.lencode = H), (P.lenbits = 9), (P.distcode = M), (P.distbits = 5), (n.mode = 20), 6 !== t)) break;
                              (c >>>= 2), (d -= 2);
                              break e;
                            case 2:
                              n.mode = 17;
                      ...
                      case 16:
                        if ((h = n.length)) {
                          ...
                          D.arraySet(o, r, a, h, i), (s -= h), (a += h), (l -= h), (i += h), (n.length -= h);
                        } else n.mode = 12;
                        break;
                      case 17:
                        for (; d < 14; ) {
                      ...
                      case 19:
                        for (; n.have < n.nlen + n.ndist; ) {
                          for (; (g = ((C = n.lencode[c & ((1 << n.lenbits) - 1)]) >>> 16) & 255), (w = 65535 & C), !((p = C >>> 24) <= d); ) {
                            if (0 === s) break e;
                            s--, (c += r[a++] << d), (d += 8);
                          }
                      ...
                      case 21:
                        ...
                        for (
                          n.back = 0;
                          (g = ((C = n.lencode[c & ((1 << n.lenbits) - 1)]) >>> 16) & 255), (w = 65535 & C), !((p = C >>> 24) <= d);
                        ...
                        if (g && 0 == (240 & g)) {
                          for (
                            v = p, y = g, k = w;
                            (g = ((C = n.lencode[k + ((c & ((1 << (v + y)) - 1)) >> v)]) >>> 16) & 255), (w = 65535 & C), !(v + (p = C >>> 24) <= d);
                      ...
                      case 23:
                        for (; (g = ((C = n.distcode[c & ((1 << n.distbits) - 1)]) >>> 16) & 255), (w = 65535 & C), !((p = C >>> 24) <= d); ) {
                          if (0 === s) break e;
                          s--, (c += r[a++] << d), (d += 8);
                        }
                        if (0 == (240 & g)) {
                          for (
                            v = p, y = g, k = w;
                            (g = ((C = n.distcode[k + ((c & ((1 << (v + y)) - 1)) >> v)]) >>> 16) & 255), (w = 65535 & C), !(v + (p = C >>> 24) <= d);
                  ...
                  return (
                    ...
                    (n.hold = c),
                    (n.bits = d),
                    (n.wsize || (f !== e.avail_out && n.mode < 30 && (n.mode < 27 || 4 !== t))) && Z(e, e.output, e.next_out, f - e.avail_out)
                      ? ((n.mode = 31), -4)
                      : ((u -= e.avail_in),
                        (f -= e.avail_out),
                        (e.total_in += u),
                ...
                (n.inflateEnd = function (e) {
                  var t;
                  return e && e.state ? ((t = e.state).window && (t.window = null), (e.state = null), L) : O;
                }),
                (n.inflateGetHeader = function (e, t) {
                  return e && e.state && 0 != (2 & (e = e.state).wrap) ? (((e.head = t).done = !1), L) : O;
                }),
            ...
            "zlib/inffast.js": function (e, t, n) {
              ...
              t.exports = function (e, t) {
                var n,
                  ...
                  C = (1 << l.distbits) - 1;
                e: do {
                  for (_ < 15 && ((k += d[c++] << _), (_ += 8), (k += d[c++] << _), (_ += 8)), n = x[k & E]; ; ) {
                    if (((k >>>= r = n >>> 24), (_ -= r), 0 == (r = (n >>> 16) & 255))) h[f++] = 65535 & n;
                      ...
                      for (
                        o = 65535 & n,
                          (r &= 15) && (_ < r && ((k += d[c++] << _), (_ += 8)), (o += k & ((1 << r) - 1)), (k >>>= r), (_ -= r)),
                          _ < 15 && ((k += d[c++] << _), (_ += 8), (k += d[c++] << _), (_ += 8)),
                          n = S[k & C];
                        ;
                        ...
                        if (
                          ((a = 65535 & n),
                          _ < (r &= 15) && ((k += d[c++] << _), (_ += 8) < r && ((k += d[c++] << _), (_ += 8))),
                          p < (a += k & ((1 << r) - 1)))
                        ) {
            ...
            "zlib/inftrees.js": function (e, t, n) {
              ...
              t.exports = function (e, t, n, r, o, a, i, s) {
                ...
                if ((k < _ && (_ = k), 0 === k)) (o[a++] = 20971520), (o[a++] = 20971520), (s.bits = 1);
                  ...
                  for (y = 1; y < k && 0 === P[y]; y++);
                  for (_ < y && (_ = y), w = E = 1; w <= 15; w++) if ((E = (E <<= 1) - P[w]) < 0) return -1;
                  if (0 < E && (0 === e || 1 !== k)) return -1;
                  for (D[1] = 0, w = 1; w < 15; w++) D[w + 1] = D[w] + P[w];
                  for (v = 0; v < r; v++) 0 !== t[n + v] && (i[D[t[n + v]]++] = v);
                  if (
                    ((h = 0 === e ? ((A = B = i), 19) : 1 === e ? ((A = z), (T -= 257), (B = L), (R -= 257), 256) : ((A = O), (B = F), -1)),
                    (w = y),
                    (f = a),
                    (S = v = U = 0),
                    (d = -1),
                  ...
                  for (;;) {
                    for (
                      p = i[v] < h ? ((b = 0), i[v]) : i[v] > h ? ((b = B[R + i[v]]), A[T + i[v]]) : ((b = 96), 0),
                        l = 1 << (m = w - S),
                        y = c = 1 << x;
                      (o[f + (U >> S) + (c -= l)] = (m << 24) | (b << 16) | p | 0), 0 !== c;

                    );
                    for (l = 1 << (w - 1); U & l; ) l >>= 1;
                    if (((U = 0 !== l ? (U & (l - 1)) + l : 0), v++, 0 == --P[w])) {
                      if (w === k) break;
                      w = t[n + i[v]];
                    }
                    if (_ < w && (U & u) !== d) {
                      for (f += y, E = 1 << (x = w - (S = 0 === S ? _ : S)); x + S < k && !((E -= P[x + S]) <= 0); ) x++, (E <<= 1);
    ...
    br: {
      hasUnityMarker: function (e) {
        ...
        for (var a = r + ((6 + (o << 4) + ((t.length - 1) << 6)) << n), i = 0; i < commentOffset; i++, a >>>= 8) if (e[i] != (255 & a)) return !1;
    ...
    b.preRun.push(function () {
      b.addRunDependency("dataUrl"),
        e.then(function (t) {
          ...
          for (
            n + s > t.length && o("Invalid binary data file header! (pos=" + n + ", headerSize=" + s + ", file length=" + t.length + ")");
            n < s;

          ) {
            var l = r(),
              c = r(),
              d = (l + c > t.length && o("Invalid binary data file size! (offset=" + l + ", size=" + c + ", file length=" + t.length + ")"), r()),
              u =
                (n + d > t.length && o("Invalid binary data file path name! (pos=" + n + ", length=" + d + ", file length=" + t.length + ")"),
                e.decode(t.subarray(n, n + d)));
            n += d;
            for (var f = 0, h = u.indexOf("/", f) + 1; 0 < h; f = h, h = u.indexOf("/", f) + 1)
            ...
            b.postRun.push(function () {
              l(1),
                b.WebPlayer.WaitForInitialization().then(function () {
                  delete b.startupErrorHandler, e(_), (b.pageStartupTime = performance.now());
                });
            }),
